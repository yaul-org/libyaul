...
enum ftdi_mpsse_mode {
  ...
  BITMODE_OPTO = 0x10, /**< Fast Opto-Isolated Serial Interface Mode, available
                          on 2232x chips  */
  BITMODE_CBUS = 0x20, /**< Bitbang on CBUS pins of R-type chips, configure in
                          EEPROM before */
  BITMODE_SYNCFF = 0x40, /**< Single Channel Synchronous FIFO mode, available on
                            2232H chips */
};
...
#define DIV_VALUE(rate)                                                        \
  (rate > 6000000)                                                             \
      ? 0                                                                      \
      : ((6000000 / rate - 1) > 0xffff) ? 0xffff : (6000000 / rate - 1)
...
int DEPRECATED(ftdi_enable_bitbang(struct ftdi_context *ftdi,
...
/* "eeprom" needs to be valid 128 byte eeprom (generated by the eeprom
   generator) the checksum of the eeprom is valided */
