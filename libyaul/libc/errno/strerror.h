 ...
 * included multiple times to declare and define a structure with these
 * messages, and then to define a lookup table translating error codes to
 * offsets of corresponding fields in the structure. */
