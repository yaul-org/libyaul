...
#ifndef _YAUL_GAMEMATH_INT16_H_
#define _YAUL_GAMEMATH_INT16_H_
...
/// @param[out] result Not yet documented.
static inline void __always_inline
int16_vec2_scale(int8_t scalar, const int16_vec2_t * __restrict v0,
  int16_vec2_t * __restrict result)
{
...
static inline void __always_inline
int16_vec2_scaled(int8_t scalar, int16_vec2_t *in_out)
{
