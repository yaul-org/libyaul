...
static inline void buffer_clear(int32_t, int32_t, int32_t,
    int32_t);
    ...
    int num_params)
{
        ...
        case 'J':
                ...
                case 0:
                        ...
                        buffer_clear(cons.cursor.col, CONS_COLS,
                ...
                case 2:
                        ...
                        buffer_clear(0, CONS_COLS, 0, CONS_ROWS);
                        break;
                default:
                        break;
                }
