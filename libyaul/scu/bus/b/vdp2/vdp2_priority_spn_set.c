...
void vdp2_priority_spn_set(uint8_t scrn, uint8_t pri)
{
        ...
        case SCRN_NBG0:
                ...
                vdp2_state.buffered_regs.prina |= pri;
        ...
        case SCRN_NBG1:
                ...
                vdp2_state.buffered_regs.prina |= pri << 8;
        ...
        case SCRN_NBG2:
                ...
                vdp2_state.buffered_regs.prinb |= pri;
        ...
        case SCRN_NBG3:
                ...
                vdp2_state.buffered_regs.prinb |= pri << 8;
        ...
        case SCRN_RBG0:
                ...
                vdp2_state.buffered_regs.prir |= pri;
