...
vdp2_scrn_display_set(uint8_t scrn, bool transparent)
{
        ...
        _internal_state_vdp2.buffered_regs.bgon |= 1 << scrn;

        if (!transparent) {
                _internal_state_vdp2.buffered_regs.bgon |= 1 << (scrn + 8);
        }
        ...
        if (((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG0)) != 0x0000) &&
            ((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG2)) != 0x0000)) {
                /* Determine the CC_COUNT for NBG0 */
                cc_count = (_internal_state_vdp2.buffered_regs.chctla & 0x0070) >> 4;
        ...
        if (((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG0)) != 0x0000) &&
           (((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG1)) != 0x0000) ||
            ((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG2)) != 0x0000) ||
            ((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG3)) != 0x0000))) {
                /* Determine the CC_COUNT for NBG0 */
                cc_count = (_internal_state_vdp2.buffered_regs.chctla & 0x0070) >> 4;
        ...
        if (((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG1)) != 0x0000) &&
            ((_internal_state_vdp2.buffered_regs.bgon & (1 << SCRN_NBG3)) != 0x0000)) {
                /* Determine the CC_COUNT for NBG1 */
                cc_count = (_internal_state_vdp2.buffered_regs.chctla & 0x3000) >> 12;
                assert((cc_count != SCRN_CCC_PALETTE_2048) &&
                       (cc_count != SCRN_CCC_RGB_32768));
        }
#endif /* DEBUG */
