...
vdp2_scrn_display_set(uint8_t scrn, bool transparent)
{
        ...
        if (((_state_vdp2()->regs.bgon & (1 << SCRN_NBG0)) != 0x0000) &&
            ((_state_vdp2()->regs.bgon & (1 << SCRN_NBG2)) != 0x0000)) {
        ...
        if (((_state_vdp2()->regs.bgon & (1 << SCRN_NBG0)) != 0x0000) &&
           (((_state_vdp2()->regs.bgon & (1 << SCRN_NBG1)) != 0x0000) ||
            ((_state_vdp2()->regs.bgon & (1 << SCRN_NBG2)) != 0x0000) ||
            ((_state_vdp2()->regs.bgon & (1 << SCRN_NBG3)) != 0x0000))) {
                /* Determine the CC_COUNT for NBG0 */
                cc_count = (_state_vdp2()->regs.chctla & 0x0070) >> 4;
        ...
        if (((_state_vdp2()->regs.bgon & (1 << SCRN_NBG1)) != 0x0000) &&
            ((_state_vdp2()->regs.bgon & (1 << SCRN_NBG3)) != 0x0000)) {
