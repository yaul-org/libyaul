...
{
    _state_vdp2()->shadow_regs.tvmd &= 0x7EFF;
}

void
vdp2_tvmd_display_set(void)
{
    _state_vdp2()->shadow_regs.tvmd |= 0x8000;
}
  ...
  vdp2_tvmd_vert_t vertical)
{
    ...
    _state_vdp2()->shadow_regs.tvmd &= 0xFFCF;
    ...
    case VDP2_TVMD_VERT_240:
        height = 240;
        _state_vdp2()->shadow_regs.tvmd |= 0x0010;
        break;
    case VDP2_TVMD_VERT_256:
        height = 256;
        _state_vdp2()->shadow_regs.tvmd |= 0x0020;
        break;
    default:
        height = 224;
        break;
    ...
    _state_vdp2()->shadow_regs.tvmd &= 0xFF3F;

    switch (interlace)  {
    case VDP2_TVMD_INTERLACE_NONE:
        break;
    case VDP2_TVMD_INTERLACE_SINGLE:
        _state_vdp2()->shadow_regs.tvmd |= 0x0080;
        break;
    case VDP2_TVMD_INTERLACE_DOUBLE:
        height *= 2;
        _state_vdp2()->shadow_regs.tvmd |= 0x00C0;
        break;
    default:
        break;
    }
    ...
    _state_vdp2()->shadow_regs.tvmd &= 0xFFF0;
    ...
    case VDP2_TVMD_HORZ_NORMAL_B:
        ...
        _state_vdp2()->shadow_regs.tvmd |= 0x0001;
        break;
    case VDP2_TVMD_HORZ_HIRESO_A:
        width = 640;
        _state_vdp2()->shadow_regs.tvmd |= 0x0002;
        break;
    case VDP2_TVMD_HORZ_HIRESO_B:
        width = 704;
        clock_speed = CPU_CLOCK_SPEED_28MHZ;
        _state_vdp2()->shadow_regs.tvmd |= 0x0003;
        break;
    case VDP2_TVMD_HORZ_NORMAL_AE:
        width = 320;
        height = 480;
        _state_vdp2()->shadow_regs.tvmd |= 0x0004;
        break;
    case VDP2_TVMD_HORZ_NORMAL_BE:
        width = 352;
        height = 480;
        clock_speed = CPU_CLOCK_SPEED_28MHZ;
        _state_vdp2()->shadow_regs.tvmd |= 0x0005;
        break;
    case VDP2_TVMD_HORZ_HIRESO_AE:
        width = 640;
        height = 480;
        _state_vdp2()->shadow_regs.tvmd |= 0x0006;
        break;
    case VDP2_TVMD_HORZ_HIRESO_BE:
        width = 704;
        height = 480;
        clock_speed = CPU_CLOCK_SPEED_28MHZ;
        _state_vdp2()->shadow_regs.tvmd |= 0x0007;
        break;
    default:
        width = 320;
        break;
...
vdp2_tvmd_border_set(bool enable)
{
    ...
    _state_vdp2()->shadow_regs.tvmd &= 0xFEFF;
    _state_vdp2()->shadow_regs.tvmd |= 0x8000;

    if (enable) {
        _state_vdp2()->shadow_regs.tvmd |= 0x0100;
    }
}
