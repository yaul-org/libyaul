...
/// @brief Request mode.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_request_mode {
        /// @brief Module request mode.
        /// @details Requests are generated by SCI peripherial.
        CPU_DMAC_REQUEST_MODE_MODULE = 0x00,
        /// @brief Auto request mode.
        /// @details Requests are generated by DMAC internally.
        CPU_DMAC_REQUEST_MODE_AUTO   = 0x01
} cpu_dmac_request_mode_t;

/// @brief Acknowledge mode.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_dack_mode {
        /// @brief Module request mode (requests are generated by SCI).
        CPU_DMAC_DACK_MODE_READ  = 0x00,
        /// @brief Auto request mode (requests are generated by DMAC).
        CPU_DMAC_DACK_MODE_WRITE = 0x01
} cpu_dmac_dack_mode_t;

/// @brief Acknowledge level.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_dack_level {
        /// @brief Module request mode (requests are generated by SCI).
        CPU_DMAC_DACK_LEVEL_LOW  = 0x00,
        /// @brief Auto request mode (requests are generated by DMAC).
        CPU_DMAC_DACK_LEVEL_HIGH = 0x01
} cpu_dmac_dack_level_t;

/// @brief Detect mode.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_detect_mode {
        /// @brief Level detection mode.
        CPU_DMAC_DETECT_MODE_LEVEL = 0x00,
        /// @brief Edge detection mode.
        CPU_DMAC_DETECT_MODE_EDGE  = 0x01
} cpu_dmac_detect_mode_t;

/// @brief Request level.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_dreq_level {
        /// @brief Module request mode (requests are generated by SCI).
        CPU_DMAC_DREQ_LEVEL_LOW  = 0x00,
        /// @brief Auto request mode (requests are generated by DMAC).
        CPU_DMAC_DREQ_LEVEL_HIGH = 0x01
} cpu_dmac_dreq_level_t;
...
/// @brief Requests resource select.
/// @see cpu_dmac_cfg_t
typedef enum cpu_dmac_resource_select {
        /// @brief Use DREQ requests.
        CPU_DMAC_RESOURCE_SELECT_DREQ = 0x00,
        /// @brief Use RXI requests from SCI.
        CPU_DMAC_RESOURCE_SELECT_RXI  = 0x01,
        /// @brief Use TXI requests from SCI.
        CPU_DMAC_RESOURCE_SELECT_TXI  = 0x02
} cpu_dmac_resource_select_t;
