...
/// @brief Set the interrupt handler for the specified interrupt.
///
...
/// @brief Clear the interrupt handler for the specified interrupt.
///
/// @details This is a BIOS call.
///
/// @param vector The vector number.
...
/// @brief Obtain the interrupt handler for the specified interrupt.
///
/// @details This is a BIOS call.
///
/// @param vector The vector number.
