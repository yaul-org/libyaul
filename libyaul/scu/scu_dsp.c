...
{
    _ppaf_state.overflow_bit = _ppaf_state.overflow_bit ||
                               ((ppaf_bits & PPAF_OVERFLOW) != 0x00000000UL);

    _ppaf_state.end_bit = _ppaf_state.end_bit ||
                          ((ppaf_bits & PPAF_EX) == 0x00000000UL) ||
