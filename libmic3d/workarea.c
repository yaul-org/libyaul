...
fix16_mat43_t __pool_render_matrices[POOL_RENDER_MATRICES_COUNT] __aligned(16);

fix16_mat33_t __pool_light_matrices[POOL_LIGHT_MATRICES_COUNT] __aligned(16);
